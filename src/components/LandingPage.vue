...
// Dynamic image from Supabase Storage / real database product image for Craftsmanship Section
...
<template>
  <div class="space-y-20 pb-16">
    ...
    <!-- 1. HERO SECTION -->
    <section class="relative rounded-3xl overflow-hidden shadow-2xl bg-slate-900 border border-slate-200">
      <!-- Background Image with Overlay -->
      <div class="absolute inset-0 z-0">
        <img 
          src="https://images.unsplash.com/photo-1618221195710-dd6b41faaea6?auto=format&fit=crop&w=1600&q=80" 
          alt="SAFS Furniture Hero" 
          class="w-full h-full object-cover opacity-45 scale-105"
        />
        <div class="absolute inset-0 bg-gradient-to-r from-slate-950/90 via-blue-950/80 to-transparent"></div>
      </div>

      <!-- Hero Content -->
      <div class="relative z-10 max-w-3xl px-8 py-20 md:py-32 md:px-14 space-y-6 text-white">
        <div class="inline-flex items-center space-x-2 px-4 py-1.5 rounded-full bg-blue-600/30 text-blue-300 border border-blue-400/30 text-xs font-bold uppercase tracking-wider backdrop-blur-md">
        ...
        <h1 class="text-4xl md:text-6xl font-black tracking-tight leading-tight">
          Handcrafted Luxury Hardwoods for <span class="text-blue-400">Modern Living</span>
        </h1>

        <p class="text-slate-200 text-base md:text-xl leading-relaxed max-w-2xl font-medium">
          SAFS Furniture crafts solid teak, French oak, and full-grain leather pieces built to endure generations. Designed and manufactured in South Africa.
        </p>

        <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 pt-4">
          <button
            @click="emit('explore-catalog')"
            class="px-8 py-4 bg-blue-700 hover:bg-blue-600 text-white font-extrabold rounded-2xl text-base transition-all shadow-xl shadow-blue-700/30 cursor-pointer flex items-center justify-center space-x-3 group"
          >
          ...
          <a
            href="#craftsmanship"
            class="px-6 py-4 bg-white/10 hover:bg-white/20 text-white border border-white/20 font-bold rounded-2xl text-base backdrop-blur-md transition-all text-center"
          >
            Our Workshop Story
          </a>
        </div>
      ...
      <!-- Stats Bar Ticker -->
      <div class="relative z-10 bg-blue-900/90 backdrop-blur-md border-t border-blue-800/80 p-4 grid grid-cols-2 md:grid-cols-4 gap-4 text-center text-xs text-blue-100 font-bold">
        <div class="flex items-center justify-center space-x-2">
          <Award class="w-4 h-4 text-blue-300 shrink-0" />
          <span>100% Solid Timber</span>
        </div>
        <div class="flex items-center justify-center space-x-2">
          <ShieldCheck class="w-4 h-4 text-blue-300 shrink-0" />
          <span>10-Year Warranty</span>
        </div>
        <div class="flex items-center justify-center space-x-2">
          <Truck class="w-4 h-4 text-blue-300 shrink-0" />
          <span>White-Glove SA Delivery</span>
        </div>
        <div class="flex items-center justify-center space-x-2">
          <Hammer class="w-4 h-4 text-blue-300 shrink-0" />
    ...
    <section class="space-y-8">
      <div class="text-center max-w-2xl mx-auto space-y-2">
        <span class="text-xs font-extrabold text-blue-700 uppercase tracking-widest block">Curated Collections</span>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        >
          ...
          <div class="absolute bottom-6 left-6 right-6 text-white space-y-1">
            <span class="text-xs text-blue-300 font-bold uppercase tracking-wider">Seating & Lounging</span>
        ...
        >
          ...
          <div class="absolute inset-0 bg-gradient-to-t from-slate-950/90 via-slate-950/30 to-transparent"></div>
          <div class="absolute bottom-6 left-6 right-6 text-white space-y-1">
            <span class="text-xs text-blue-300 font-bold uppercase tracking-wider">Dining & Gathering</span>
        ...
        >
          ...
          <div class="absolute inset-0 bg-gradient-to-t from-slate-950/90 via-slate-950/30 to-transparent"></div>
          <div class="absolute bottom-6 left-6 right-6 text-white space-y-1">
            <span class="text-xs text-blue-300 font-bold uppercase tracking-wider">Sideboards & Cabinets</span>
        ...
        >
          ...
          <div class="absolute inset-0 bg-gradient-to-t from-slate-950/90 via-slate-950/30 to-transparent"></div>
          <div class="absolute bottom-6 left-6 right-6 text-white space-y-1">
            <span class="text-xs text-blue-300 font-bold uppercase tracking-wider">Statement Pieces</span>
    ...
    <!-- 3. CRAFTSMANSHIP & STORY SECTION (REAL SUPABASE STORAGE IMAGE) -->
    <section id="craftsmanship" class="bg-white rounded-3xl border border-slate-200 shadow-xl overflow-hidden p-8 md:p-14">
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        <!-- Image Left: Dynamically fetched from real Supabase Storage / DB inventory -->
        ...
        <div class="lg:col-span-6 space-y-6">
          <div class="space-y-2">
            <span class="text-xs font-extrabold text-blue-700 uppercase tracking-widest block">The SAFS Furniture Guarantee</span>
          ...
          <div class="space-y-3 pt-2">
            <div class="flex items-start space-x-3">
              <CheckCircle2 class="w-5 h-5 text-blue-700 shrink-0 mt-0.5" />
              <div>
    ...
    <section class="space-y-8">
      <div class="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
        <div>
          <span class="text-xs font-extrabold text-blue-700 uppercase tracking-widest block">Real Inventory</span>
          <h2 class="text-3xl font-extrabold text-slate-900">Featured Best Sellers</h2>
        </div>

        <button 
          @click="emit('explore-catalog')"
          class="inline-flex items-center space-x-2 text-sm font-bold text-blue-700 hover:text-blue-900 cursor-pointer"
        >
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div 
          ...
          :key="product.id"
          class="bg-white border border-slate-200 hover:border-blue-400 rounded-3xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 flex flex-col justify-between group"
        >
          <div class="relative h-64 overflow-hidden bg-slate-100 cursor-pointer" @click="emit('select-product', product)">
            ...
            />
            <div class="absolute top-3 left-3 px-3 py-1 bg-blue-700 text-white text-xs font-bold rounded-lg shadow-md uppercase tracking-wider">
              Best Seller
            </div>
          ...
          <div class="p-6 flex-1 flex flex-col justify-between space-y-4">
            <div class="space-y-1 cursor-pointer" @click="emit('select-product', product)">
              <h3 class="text-lg font-extrabold text-slate-900 group-hover:text-blue-700 transition-colors">
                {{ product.name }}
              </h3>
            ...
            <div class="pt-4 border-t border-slate-100 flex items-center justify-between">
              ...
              <div class="flex items-center space-x-2">
                <button 
                  ...
                  class="px-3.5 py-2 bg-blue-50 text-blue-700 hover:bg-blue-100 rounded-xl text-xs font-bold transition-colors cursor-pointer"
                >
                  Details
                </button>
                <button 
                  @click.stop="emit('quick-add-to-cart', product)"
                  class="p-2 bg-blue-700 hover:bg-blue-800 text-white rounded-xl shadow-sm cursor-pointer"
    ...
    <section class="max-w-4xl mx-auto space-y-6">
      <div class="text-center space-y-2">
        <span class="text-xs font-extrabold text-blue-700 uppercase tracking-widest block">Got Questions?</span>
      ...
      <div class="space-y-3">
        ...
        >
          ...
          >
            ...
            <ChevronUp v-if="activeFaq === idx" class="w-5 h-5 text-blue-700" />
